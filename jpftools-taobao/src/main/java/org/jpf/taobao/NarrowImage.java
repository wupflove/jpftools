...
* @version 创建时间：2017年11月20日 下午8:42:03 
* 类说明 
*/ 
...
public class NarrowImage {
    ...
    public BufferedImage zoomImage(String src) {  
        ...
        try {  
            ...
            //压缩计算  
            float resizeTimes = 0.9f;  /*这个参数是要转化成的倍数,如果是1就是转化成1倍*/  
     ...
     public static void main(String[] args) {  
         ...
         String inputFoler = "D:\\zgb\\处理后\\胡燕\\201711\\11.20\\1\\22c5147d-1.jpg" ;   
         /*这儿填写你存放要缩小图片的文件夹全地址*/  
        String outputFolder = "D:\\zgb\\处理后\\胡燕\\201711\\11.20\\1\\22c5147d-1.jpg";    
        /*这儿填写你转化后的图片存放的文件夹*/  
